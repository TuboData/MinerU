...
if __name__ == '__main__':
    ...
    model_dir = snapshot_download('opendatalab/PDF-Extract-Kit-1.0', allow_patterns=mineru_patterns, local_dir="models/miner-u/miner-u")
    layoutreader_model_dir = snapshot_download('ppaanngggg/layoutreader', local_dir="models/miner-u/layout-reader")
